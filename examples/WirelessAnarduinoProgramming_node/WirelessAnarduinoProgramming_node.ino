// **********************************************************************************
// This sketch is an example of how wireless programming can be achieved with a Anarduino
// miniWireless  that was loaded with a custom 1k bootloader (DualOptiboot) that is capable of loading
...
// **********************************************************************************
// Based on Copyright Felix Rusu, LowPowerLab.com
// **********************************************************************************
// License
// **********************************************************************************
...
#include <SPI.h>
#include <SPIFlashA.h>      //get it here: ﻿https://github.com/rrobinet/SPIFlashA.
#include <avr/wdt.h>
#include <WirelessAnarduinoHEX69.h> //get it here: https://github.com/LowPowerLab/WirelessProgramming/tree/master/WirelessHEX69
...
#define BLINKPERIOD 500
  ...
  #define FLASH_SS      5 // and FLASH SS on D5 for miniWireless
#endif
...
// SPI_CS          - CS pin attached to SPI flash chip (5 in case of miniWireless)
// MANUFACTURER_ID - OPTIONAL, 0x12018 SPANION S25FL127S
/////////////////////////////////////////////////////////////////////////////
SPIFlashA flash(FLASH_SS, 0x12018); // For narduino miniWireless with SPANION S25FL127S
void setup(){
  pinMode(LED, OUTPUT);
